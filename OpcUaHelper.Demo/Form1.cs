...
namespace OpcUaHelper.Demo
{
    public partial class Form1 : Form
    {
        ...
        public Form1( )
        {
            ...
            m_OpcUaClient.ReconnectPeriod = 1;
        ...
        private void M_OpcUaClient_ConnectComplete(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!timer.Enabled)
                {
                    ...
                    timer.Enabled = true;
                    System.Diagnostics.Debug.Print("mulai timer");
                }
            }
        }
        ...
        private void Timer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            if (!m_OpcUaClient.Connected)
            {
                System.Diagnostics.Debug.Print(m_OpcUaClient.Connected.ToString());
                LblStatusConnection.Invoke((MethodInvoker)delegate
                {
                    LblStatusConnection.Text = "Reconnecting in 3s";
                });
                try
                {
                    m_OpcUaClient.ConnectServer(TxtURLOPCUA.Text);
                }
                catch
                {
                }
        ...
        private void BtnConnect_Click(object sender, EventArgs e)
        {
            try
            {
                //await m_OpcUaClient.ConnectServer("opc.tcp://127.0.0.1:49320");
                m_OpcUaClient.ConnectServer(TxtURLOPCUA.Text);
            }
            catch (Exception ex)
            {
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                //short value = m_OpcUaClient.ReadNode<short>("ns=2;s=Channel_SIM.Device_SIM.suhu");
